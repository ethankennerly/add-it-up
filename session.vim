...
silent only
cd C:\archive\unity\add-it-up\Assets\Scripts
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 \archive\unity\add-it-up\design.txt
badd +137 \archive\unity\add-it-up\screenplay.txt
badd +55 \archive\unity\fit\Assets\Scripts\toykit\ViewUtil.cs
badd +20 unity-toykit\framework\Model.cs
badd +26 unity-toykit\framework\Controller.cs
badd +118 unity-toykit\toolkit\ControllerUtil.cs
badd +1 unity-toykit\framework\MainView.cs
badd +3 unity-toykit\framework\ViewModel.cs
badd +7 Model.cs
badd +1 unity-toykit\framework\IModel.cs
badd +1 ViewModel.cs
badd +3 unity-toykit\framework\IViewModel.cs
badd +15 unity-toykit\toolkit\ViewUtil.cs
badd +1 \archive\unity\anagram\Assets\Scripts\Main.cs
badd +136 \archive\unity\anagram\Assets\Scripts\View.cs
badd +1 unity-toykit\toolkit\InputUtil.cs
badd +1 unity-toykit\toolkit\InputController.cs
badd +12 unity-toykit\framework\ControllerTemplate.cs
badd +1 unity-toykit\framework\View.cs
badd +1 unity-toykit\framework\ViewTemplate.cs
badd +3 View.cs
badd +14 Controller.cs
badd +1 ViewTemplate.cs
badd +17 unity-toykit\toolkit\Toolkit.cs
...
badd +3 unity-toykit\toolkit\Deck.cs
badd +19 Editor\Tests\TestModel.cs
badd +0 Editor\Tests\TestWordGrid.cs
badd +1 README.md
badd +0 \archive\unity\add-it-up\README.md
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 142 - ((0 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
142
normal! 012l
tabedit unity-toykit\framework\MainView.cs
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 65 - ((26 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
65
